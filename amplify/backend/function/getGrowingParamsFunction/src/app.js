...
var middleware_1 = __importDefault(
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            new AWS.SSM({ region: 'us-east-1' })
              .getParameters({
                Names: [
                  'GOOGLE_API_KEY',
                  'NOAA_TOKEN',
                  'NOAA_TOKEN_BACKUP'
                ].map(function (secretName) {
        ...
        case 1:
          ...
          (GOOGLE_API_KEY = Parameters[0]),
            (NOAA_TOKEN = Parameters[1]),
            (NOAA_TOKEN_BACKUP = Parameters[2]);
          (_a = req.body),
            (zipcode = _a.zipcode),
            (street = _a.street),
            (city = _a.city),
          ...
          return [
            4 /*yield*/,
            new GrowingCalculations_1.GrowingCalculations(
              zipcode,
              street,
              city,
              state,
        ...
        case 2:
          (_b = _c.sent()),
            (hardinessZone = _b.hardinessZone),
            (firstGdd45 = _b.firstGdd45),
            (lastGdd45 = _b.lastGdd45),
            (growingSeasonLength = _b.growingSeasonLength);
          // Add your code here
          res.status(200).send({
